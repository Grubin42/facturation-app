...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Enabled Remote (Activer images à distance)
    |--------------------------------------------------------------------------
    |
    | Enables the remote access and evaluation of external resources.
    | IMPORTANT : Active uniquement si vous avez confiance en vos sources!
    |
    */
